...
win = t.Screen()  # creating a window for a game  ///sadasdsa
...
pen.hideturtle()
pen.goto(0, 260)
pen.write("Player sajin: 0        Player shreeya: 0 ", align="center", font=('Monaco', 19, "normal" ))
...
while True:
    ...
    if ball.xcor() > 390:  # right width paddle Border
        ...
        pen.clear()
        pen.write("Player sajin : {}                    Player shreeya: {} ".format(player_a_score, player_b_score),
